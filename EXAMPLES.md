# Casos de Teste - VerificAI

Este documento reúne exemplos reais de mensagens processadas pelo sistema, com o intuito de ilustrar os resultados e as análises feitas por ele.

---

## 1. Falsa lista de bolsistas
...
> "Bom dia,
>
> Temos o prazer de informar que a lista dos alunos selecionados para a bolsa de estudos já está disponível online e o seu nome consta nela.
> Para consultar a lista completa e obter mais informações, convidamos você a visitar a página dedicada: Página informativa – LISTA DOS BOLSISTAS.
> http://srv244789.hoster-test.ru/rNDdNsqxPMpNH
>
...
1. **Domínio Suspeito:** Apesar de a mensagem parecer vir de um e-mail de aluno da UECE e falar sobre bolsas, o link que ela sugere para você acessar (http://srv244789.hoster-test.ru/rNDdNsqxPMpNH) **não pertence à UECE**. O domínio .ru é da Rússia, e informações oficiais da nossa universidade seriam publicadas em uece.br. Esta é uma tática muito comum para tentar enganar você e roubar seus dados.
2. **Urgência e Engenharia Social:** O termo 'U.rgente' no assunto e a notícia de que seu nome 'consta' na lista de bolsistas são usados para criar um senso de pressa e empolgação, buscando que você clique no link sem pensar muito. Essa é uma estratégia conhecida em ataques de phishing para diminuir suas defesas.
3. **Impersonificação:** Há uma clara tentativa de se passar por uma comunicação oficial da UECE para um assunto tão importante quanto bolsas de estudo, mas direcionando para um site que não é da instituição.
...
> "Prezado(a),
>
> No âmbito da avaliação das atividades desenvolvidas na Universidade Estadual do Ceará (UECE), foi elaborada uma lista de beneficiários para a concessão do Prêmio de Incentivo.
>
> Temos a satisfação de informar que Vossa Senhoria integra a lista de beneficiários(as) deste prêmio, em reconhecimento ao seu empenho, dedicação e contribuição às atividades, projetos, iniciativas e missões institucionais da UECE.
>
> As informações detalhadas sobre os critérios, as modalidades de concessão e a lista completa dos(as) beneficiários(as) estão disponíveis no portal institucional da UECE, por meio do link abaixo: https://www.uece.br/ublicacao/premiodeincentivo-2026Uece
> Solicitamos, gentilmente, que consulte o conteúdo.
>
> Atenciosamente,
...
## 3. Ataque "Prova de Vida"

**Veredito:** 🔴 MALICIOUS

**Mensagem:**
> "O Departamento de Gestão de Pessoas da Universidade Estadual do Ceará (Uece) reforça a necessidade de que os servidores realizem o Recadastramento e a Prova de Vida obrigatórios junto ao Estado do Ceará, a fim de evitar o bloqueio de seus vencimentos.

Segundo a Fundação de Previdência Social do Estado do Ceará (Cearaprev), os servidores estaduais ainda podem efetuar o Recadastramento e a Prova de Vida 2025. Para evitar o bloqueio de vencimentos ou benefícios, é imprescindível que ambos os procedimentos sejam realizados.

Os processos estão disponíveis no aplicativo Cearaprev On-line, que pode ser baixado gratuitamente nas lojas App Store e Google Play. A plataforma foi desenvolvida com o objetivo de garantir maior simplicidade, agilidade e segurança às etapas de atualização cadastral.

Utilize o link para concluir seu novo cadastro.

Em situações excepcionais, o Recadastramento e a Prova de Vida poderão ser realizados presencialmente na sede da Cearaprev, de segunda a sexta-feira, das 8h às 12h e das 13h às 17h.

Canais de atendimento:
* Central de Atendimento: (85) 3108-0135
* Ouvidoria: (85) 3108-2929 | ✉️ ouvidoria@cearaprev.ce.gov.br
...
Temos o prazer de informar que a lista de estudantes selecionados para a bolsa de estudos já está disponível online. O seu nome consta na lista.
Para consultar a lista completa e obter mais informações, visite a página dedicada: Página de Informações sobre a LISTA DE DIVULGAÇÃO
...
Deixe-me explicar o porquê, para que você possa entender melhor e se proteger no futuro:

1. **Domínio Falso e Impersonificação:** A mensagem fala sobre uma 'bolsa de estudos' da UECE e incentiva você a clicar em um link. Embora o remetente original utilize um e-mail com domínio aluno.uece.br, o link fornecido (https://arthemistralmmpres.jimdofree.com/infobr/) **NÃO pertence à UECE!** jimdofree.com é um serviço de criação de sites gratuitos e não é o domínio oficial da nossa universidade (que sempre seria uece.br). Essa é uma tática muito comum em golpes de *phishing*, onde criminosos criam páginas falsas para roubar suas informações.
